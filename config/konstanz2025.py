...
year = 2025
startday = pd.Timestamp(year, 6, 1)  # TODO: UPDATE with actual start date
endday = pd.Timestamp(year, 8, 31)  # TODO: UPDATE with actual end date
...
feedercam_input_dir = Path(os.path.join(basedir,'pi/')_
